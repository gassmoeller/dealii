...
#include <deal.II/fe/mapping_manifold_eulerian.h>
...
MappingManifoldEulerian<dim, VectorType, spacedim>::MappingManifoldEulerian(
...
MappingManifoldEulerian<dim, VectorType, spacedim>::clone() const
{
  return std::make_unique<MappingManifoldEulerian<dim, VectorType, spacedim>>(
    degree, *euler_dof_handler, *euler_vector, this->level);
}
...
template <int dim, typename VectorType, int spacedim>
MappingManifoldEulerian<dim, VectorType, spacedim>::SupportQuadrature::
...
#endif
                               >
MappingManifoldEulerian<dim, VectorType, spacedim>::get_vertices(
...
MappingManifoldEulerian<dim, VectorType, spacedim>::
...
MappingManifoldEulerian<dim, VectorType, spacedim>::fill_fe_values(
...
#include "fe/mapping_manifold_eulerian.inst"
