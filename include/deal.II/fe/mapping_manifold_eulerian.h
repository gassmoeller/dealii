...
#ifndef dealii_mapping_manifold_eulerian_h
#define dealii_mapping_manifold_eulerian_h
...
class MappingManifoldEulerian : public MappingManifold<dim, spacedim>
{
public:
  /**
   * Constructor.
...
inline bool
MappingManifoldEulerian<dim, VectorType, spacedim>::preserves_vertex_locations()
  const
{
  return false;
}
